...
static void SDL_ANDROID_SensorUpdate(SDL_Sensor *sensor)
{
    ...
    /* ALooper_pollAll was made unavailable by newer NDK headers (this vendored
       SDL2 2.28.1 predates that removal); ALooper_pollOnce is a drop-in
       replacement for this single non-blocking check. */
